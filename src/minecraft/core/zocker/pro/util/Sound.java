...
public enum Sound {
	...
	public static org.bukkit.Sound getFromName(String soundName) {
		org.bukkit.Sound sound = cachedSoundMap.get(soundName.toUpperCase());
		if (sound != null)
			return sound;
	...
	private org.bukkit.Sound getBukkitSound() {
	...
	public org.bukkit.Sound getSound() {
		if (this.getBukkitSound() != null) {
			return this.getBukkitSound();
		}
...
//	public static void stopSound(Player player, Location location) {
